...
public class TripParticipantController {
    ...
    ) throws PersonNotFoundException, AlreadyExistsException, TripNotFoundException, WrongParametersException {
    ...
    public ResponseEntity<?> getTripParticipant(@PathVariable Long tripID, @RequestParam(name = "personID") Long personID) throws PersonNotFoundException, TripNotFoundException, WrongParametersException {
        return ResponseEntity.ok(service.getTripParticipant(berryPersonService.findById(personID), tripService.findTripById(tripID)));
    }

    @GetMapping("/users") //
    public ResponseEntity<?> getAllTripParticipants(@PathVariable Long tripID) throws TripNotFoundException, WrongParametersException {
        return ResponseEntity.ok(service.getAllTripParticipants(tripService.findTripById(tripID)));
    }

    @PutMapping("/users") //personID
    public ResponseEntity<?> approveTripParticipant(@PathVariable(name = "tripID") Long tripID, @RequestParam(name = "personID") Long personId) throws PersonNotFoundException, TripNotFoundException, WrongParametersException {
    ...
    public ResponseEntity<?> refuseTripParticipant(@PathVariable(name = "tripID") Long tripID, @RequestParam(name = "personID") Long personID) throws PersonNotFoundException, TripNotFoundException, WrongParametersException {
