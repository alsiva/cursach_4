...
public class ApplicationConfig {
    ...
    public UserDetailsService userDetailsService(){
        return credentials -> repository.findByUsernameLikeIgnoreCaseOrEmailLikeIgnoreCase(credentials, credentials).orElseThrow(() -> new RuntimeException("User not found!"));
    }
